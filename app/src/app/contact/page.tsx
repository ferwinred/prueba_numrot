...
import { useCreateUserMutation } from "../../toolkit/services/userApi";
...
function Form() {
  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    const body = { ...data, id: 0, age: parseInt(data.age, 10) };
    ...
    <div className="d-flex justify-content-center">
      <form className="" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="col-12 d-md-flex justify-content-md-center">
          <button type="submit" className="btn btn-dark hover:btn-light mt-3">
            Enviar
          </button>
        </div>
